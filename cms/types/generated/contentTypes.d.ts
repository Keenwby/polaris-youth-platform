...
export interface ApiActivityActivity extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'Youth development activities and events';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    category: Attribute.Enumeration<
      ['workshop', 'seminar', 'community', 'project', 'other']
    > &
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  info: {
    ...
    description: 'Homepage content with dynamic zones';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSiteSettingSiteSetting extends Schema.SingleType {
  ...
  attributes: {
    siteName: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'\u5317\u8FB0\u9752\u5E74\u53D1\u5C55\u4E2D\u5FC3'>;
    siteDescription: Attribute.Text &
      Attribute.Required &
      Attribute.DefaultTo<'\u8BA9\u9752\u5E74\u6D3B\u6210\u81EA\u5DF1\u60F3\u8981\u7684\u6A21\u6837'>;
    ...
    seo: Attribute.Component<'seo.meta-data'>;
    navigation: Attribute.JSON & Attribute.DefaultTo<[]>;
